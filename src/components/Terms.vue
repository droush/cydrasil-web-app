<template>
  <v-container fluid>
    ...
    >
      <div>
        <v-card
          class="pa-2 grey--text text--darken-3"
          outlined
        >
          <v-divider />
          <v-card-subtitle
          ...
          <v-card-text>
            ...
            <br>
            <br>
            This website is operated by Cydrasil. Throughout the site, the terms “we”, “us” and “our”
            refer to Cydrasil. Cydrasil offers this website, including all information, tools and services
            available from this site to you, the user, conditioned upon your acceptance of all terms, conditions,
            policies and notices stated here.
            <br>
            <br>
            By visiting our site and/ or creating an account, you engage in our “Service” and agree to be bound
            ...
            <br>
            <br>
            Any new features or tools which are added to the current web page shall also be subject to the Terms
            ...
            Your continued use of or access to the website following the posting of any changes constitutes acceptance
            of those changes.
            <br>
            <br>
            SECTION 1 – CYDRASIL WEB APPLICATION TERMS
            <br>
            <br>
            ...
            services may be limited and are subject to return or exchange only according to our Return Policy.
            <br>
            <br>
            ...
            not have any liability or responsibility for any third-party materials or websites, or for any other materials,
            ...
            Our Privacy Policy is posted further down this page.
            <br>
            <br>
            ...
            inaccuracies, or omissions. We reserve the right to correct any errors, inaccuracies or omissions, and
            to change or update information if any information in the Service or on any related website is inaccurate
            ...
            other websites, or the Internet; (h) to collect or track the personal information of others; (i) to spam,
            ...
            <br>
            <br>
            In no case shall Cydrasil, our directors, officers, employees, affiliates, agents, contractors,
            ...
            do not allow the exclusion or the limitation of liability for consequential or incidental damages,
            ...
            <br>
            <br>
            You agree to indemnify, defend and hold harmless Cydrasil and our parent, subsidiaries, affiliates,
            ...
            use of the Service, superseding any prior or contemporaneous agreements, communications and proposals,
            ...
            governed by and construed in accordance with the laws of the State of Arizona and the United States of America.
            <br>
            <br>
            ...
            Terms of Service by posting updates and changes to our website. It is your responsibility to check
            ...
            <br>
            <br>
            Questions about the Terms of Service should be sent to us at cydrasil@asu.edu.
          </v-card-text>
        </v-card>
      </div>
    </section>
