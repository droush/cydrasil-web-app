    ...
    <section>
      ...
      <div>
        ...
        >
          ...
          <v-card-text>
            Currently, we are taking sequence submissions through our contact email at (contact AT cydrasil DOT org). We are only accepting 16S rRNA gene sequences with lengths greater than 1100 base pairs.
          </v-card-text>
        </v-card>
      </div>
      <div>
